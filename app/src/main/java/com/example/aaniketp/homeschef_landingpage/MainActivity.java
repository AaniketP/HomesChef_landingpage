...
public class MainActivity extends AppCompatActivity implements LandingPageFragment.OnFragmentInteractionListener, NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LandingPageFragment landingPageFragment = new LandingPageFragment();
        args.putString("Adding","true");
        landingPageFragment.setArguments(args);
        landingPageFragment.setHasOptionsMenu(true);

        getSupportActionBar().setDefaultDisplayHomeAsUpEnabled(true);
        fragmentTransaction.add(R.id.fragment_container,landingPageFragment);
